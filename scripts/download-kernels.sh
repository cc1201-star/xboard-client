...
# Geo databases (geoip.dat, geosite.dat) — required by GEOIP/GEOSITE rules
GEO_BASE="https://github.com/MetaCubeX/meta-rules-dat/releases/latest/download"
echo ""
echo "== downloading geo databases =="
fetch "$GEO_BASE/geoip.dat" "$ASSETS/geoip.dat"
fetch "$GEO_BASE/geosite.dat" "$ASSETS/geosite.dat"
